...
namespace WorldView
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
        ...
        private ToolStripMenuItem vibrationToolStripMenuItem;
        private ToolStripMenuItem fireFieldToolStripMenuItem;
        private ToolStripMenuItem temperatureToolStripMenuItem;
        private ToolStripMenuItem strainToolStripMenuItem;
		...
		private void InitializeComponent()
		{
            ...
            this.vibrationToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.fireFieldToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.temperatureToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.strainToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
        ...
        */
		...
		private void menuItemLayoutByXml_Click(object sender, System.EventArgs e)
		{
            ...
            Stream xmlStream = assembly.GetManifestResourceStream("WorldView.Resources.WorldView.xml");
        ...
        private void vibrationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            /*
            if (dockPanel.DocumentStyle == DocumentStyles.SystemMdi)
            {
                m_viewVibration.MdiParent = this;
                m_viewVibration.Show();
            }
            else
        ...
        private void fireFieldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dockPanel.DocumentStyle == DocumentStyles.SystemMdi)
            {
                m_viewFireField.MdiParent = this;
                m_viewFireField.Show();
            }
            else
                m_viewFireField.Show(dockPanel);
